...
Let $X$ ~ $N(\mu_1, \sigma_1^2)$, $Y$ ~ $N(\mu_2, \sigma_2^2)$. Then, $Z = X + Y $~ $N(\mu_1 + \mu_2, \sigma_1^2 + \sigma_2^2)$
...
lines(x = xlines,y=dnorm(xlines, mean(mean), mean(sd)) *length(x)*diff(h$breaks)[1])
